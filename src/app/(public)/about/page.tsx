  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="glass-panel p-6 rounded-3xl space-y-3 text-center">
          ...
          <h3 className="font-bold text-white text-base">Top Influencer Roster</h3>
        ...
        <div className="glass-panel p-6 rounded-3xl space-y-3 text-center">
          ...
          <h3 className="font-bold text-white text-base">Verified UPI Payments</h3>
          <p className="text-xs text-gray-400">
        ...
        <div className="glass-panel p-6 rounded-3xl space-y-3 text-center">
          ...
          <h3 className="font-bold text-white text-base">Guaranteed Reach</h3>
          <p className="text-xs text-gray-400">
