...
export default function AdsPage() {
    ...
    try {
      const res = await fetch("/api/admin/campaigns", {
        ...
        body: JSON.stringify({
          ...
          posterUrl: formData.posterUrl || "https://images.unsplash.com/photo-1536440136628-849c177e76a1?auto=format&fit=crop&q=80&w=400",
  ...
  return (
    <div className="space-y-8">
            ...
            return (
              ...
              >
                ...
                <div className="relative h-48 rounded-xl overflow-hidden border border-[#D4AF37]/30 bg-[#0E1017]">
                  <img
                    src={ad.posterUrl || "https://images.unsplash.com/photo-1536440136628-849c177e76a1?auto=format&fit=crop&q=80&w=400"}
                    alt={ad.title}
                    className="w-full h-full object-cover"
                  />
                  {ad.posterUrl && ad.posterUrl.startsWith("/uploads/") && (
      ...
      {/* Add Ad Modal (Upload Server Poster Image, Title, Description, YouTube, Spotify) */}
      {showAddModal && (
